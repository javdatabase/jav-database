...
const STAR_IDOL_ID = "";
const SWEET_NIGHT_IDS = ["jai068", "jai068", "jai068", "jai068", "jai068"];
const BEST_DVD_IDS = ["jai068", "jai152", "jai195"];
const BEST_IDOL_IDS = ["jai068", "jai152", "jai195"];
const TOP_POINT_GROWTH_IDS = [];
const TOP_IDOL_IDS = [];
const HAS_DVD_IDS = ["jai068", "jai152", "jai195"];
const NEWBIE_IDS = [];
