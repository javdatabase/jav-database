...
const BEST_DVD_IDS = ["jai151", "jai211", "jai212"];
const BEST_IDOL_IDS = ["jai151", "jai211", "jai212"];
const TOP_POINT_GROWTH_IDS = ["jai211", "jai212"];
const TOP_IDOL_IDS = [];
const HAS_DVD_IDS = ["jai151", "jai211", "jai212"];
